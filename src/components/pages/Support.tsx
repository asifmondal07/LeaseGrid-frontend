...
import { Columns4, LayoutGrid, List, } from "lucide-react";
          ...
          <>
               <div className="px-2 py-2 space-y-6 max-w-[1600px] mx-auto">
                    ...
                    <div className="flex flex-col gap-4">
                         ...
                         <div className="flex flex-row justify-start gap-5 px-5 py-3 bg-white rounded-2xl shadow-sm shadow-gray-300">
                              <Button
